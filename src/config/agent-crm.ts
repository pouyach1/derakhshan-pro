...
export const AGENT_PROPERTIES: AgentProperty[] = [
  {
    ...
    neighborhood: siteConfig.contact.address.city,
...
export const AGENT_CLIENTS: AgentClient[] = [
  {
    ...
    preferredNeighborhood: siteConfig.contact.address.city,
    urgency: "high",
    preferredBedrooms: 3,
    notes: [
      {
        id: "n1",
        at: "۱۴۰۳/۰۶/۱۸ · ۱۴:۲۰",
        text: `بازدید از ${siteConfig.brand.nameFa} انجام شد — خریدار از نقشه راضی بود ولی تخفیف می‌خواهد.`,
      },
    ],
  },
  {
    ...
    notes: [
      {
        id: "n2",
        at: "۱۴۰۳/۰۶/۱۷ · ۱۱:۰۰",
        text: `علاقه‌مند به ${siteConfig.brand.nameFa}؛ درخواست بازدید آخر هفته.`,
      },
    ],
  },
  {
    ...
    notes: [
      {
        id: "n3",
        at: "۱۴۰۳/۰۶/۱۶ · ۱۶:۴۵",
        text: `به‌دنبال دفتر اداری نزدیک ${siteConfig.brand.nameFa}؛ بودجه منعطف تا ۱۴ میلیارد.`,
      },
    ],
  },
];
...
export const AGENT_TOURS: AgentTour[] = [
  {
    ...
    agentId: "a1",
    propertyId: "ap3",
    propertyTitle: siteConfig.brand.nameFa,
...
export const AGENT_TASKS: AgentTask[] = [
  {
    ...
    agentId: "a1",
    kind: "visit",
    title: `بازدید ${siteConfig.brand.nameFa}`,
  ...
  },
  {
    ...
    kind: "note",
    title: siteConfig.brand.nameFa,
    detail: `رضا اکبری · نیاز به فایل اداری نزدیک ${siteConfig.brand.nameFa}`,
    time: "۱۸:۳۰",
    dayLabel: "امروز",
    done: true,
  },
