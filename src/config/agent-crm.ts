...
export const AGENT_CLIENTS: AgentClient[] = [
  {
    ...
    preferredNeighborhood: "مشکین دشت",
    urgency: "high",
    preferredBedrooms: 3,
    notes: [
      {
        id: "n1",
        at: "۱۴۰۳/۰۶/۱۸ · ۱۴:۲۰",
        text: "بازدید از دپارتمان درخشان انجام شد — خریدار از نقشه راضی بود ولی تخفیف می‌خواهد.",
      },
    ],
  },
  {
    ...
    notes: [
      {
        id: "n2",
        at: "۱۴۰۳/۰۶/۱۷ · ۱۱:۰۰",
        text: "علاقه‌مند به دپارتمان درخشان؛ درخواست بازدید آخر هفته.",
      },
    ],
  },
  {
    ...
    notes: [
      {
        id: "n3",
        at: "۱۴۰۳/۰۶/۱۶ · ۱۶:۴۵",
        text: "به‌دنبال دفتر اداری نزدیک دپارتمان درخشان؛ بودجه منعطف تا ۱۴ میلیارد.",
      },
    ],
  },
];
...
export const AGENT_TASKS: AgentTask[] = [
  ...
  },
  {
    ...
    kind: "note",
    title: "دپارتمان درخشان",
    detail: "رضا اکبری · نیاز به فایل اداری نزدیک دپارتمان درخشان",
    time: "۱۸:۳۰",
    dayLabel: "امروز",
    done: true,
  },
