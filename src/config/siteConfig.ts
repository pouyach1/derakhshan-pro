...
export const siteConfig = {
  ...
  /* ======================================================================== */
  hero: {
    /** بج کوچک بالای عنوان — در هیرو جدید به‌عنوان سیگنال برند استفاده می‌شود */
    badge: "کارگزاری خصوصی املاک فاخر",
    /** عنوان اصلی هیرو */
    title: "اولین برخورد، باید همان لحظه بفروشد",
    /** زیر‌عنوان / توضیح کوتاه زیر عنوان */
    subtitle:
      "ویترین زنده فایل‌های لوکس، تیم مشاوران و مسیر معامله محرمانه — همان چیزی که دفتر شما برای بستن قرارداد بعدی نیاز دارد.",
    /** دکمهٔ اصلی */
    primaryCta: { href: "/listings", label: "ورود به آرشیو زنده" },
    /** دکمهٔ ثانویه */
    secondaryCta: { href: "/contact", label: "رزرو جلسه دمو" },
  ...
  /* ======================================================================== */
  about: {
    title: "نسخه نمایشی آماده ارائه به دفاتر املاک",
    body: "این نسخه با داده واقعی‌نما از املاک، مشاوران، لید، بازدید و معاملات موفق پر شده تا مسیر کامل سایت تا پنل مدیریت را در جلسه دمو نشان دهید. برند و تماس پیش‌فرض را قبل از تحویل نهایی با اطلاعات دفتر مشتری عوض کنید.",
