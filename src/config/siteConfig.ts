...
export const siteConfig = {
  ...
  hero: {
    /** بج کوچک بالای عنوان */
    badge: "✦ کارگزاری خصوصی املاک فاخر تهران",
    /** عنوان اصلی هیرو */
    title: "نمایش حرفه‌ای فایل‌های منتخب، از جستجو تا معامله محرمانه",
    /** زیر‌عنوان / توضیح کوتاه زیر عنوان */
    subtitle:
      "آرشیو زنده پنت‌هاوس، ویلا و دفاتر اداری؛ همراه با تیم مشاوران، پیگیری لید و کارنامه معاملات موفق برای ارائه به دفاتر املاک.",
    /** دکمهٔ اصلی */
